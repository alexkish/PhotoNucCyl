...
#ifndef G4PhotoNuclearCrossSectionBe_h
#define G4PhotoNuclearCrossSectionBe_h 1
...
class G4PhotoNuclearCrossSectionBe : public G4VCrossSectionDataSet
{
  public:

    G4PhotoNuclearCrossSectionBe(const G4String& name = "PhotoNuclearXS");
    virtual ~G4PhotoNuclearCrossSectionBe();
  ...
  private:
    ...
    void     SetupBeCrossSections();
  G4double GetBeCrossSection(double energy_in_mev);
  ...
  G4double fBeEnerg[141];
  G4double fBeCross[141];
};
